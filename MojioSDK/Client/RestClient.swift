...
open class RestClient: NSObject {
    ...
    fileprivate var requestMethod : Alamofire.HTTPMethod?
    ...
    fileprivate static let SinceBeforeDateFormat = "yyyy-MM-dd'T'HH:mm"
    ...
    open func run(_ completion: @escaping (_ response : AnyObject) -> Void, failure: @escaping (_ error : AnyObject?) -> Void) {
    ...
    open func runStringBody(_ string: String, completion: @escaping (_ response : AnyObject) -> Void, failure: @escaping (_ error : AnyObject?) -> Void) {
    ...
    open func runEncodeJSON(_ jsonObject: [String: Any], completion: @escaping (_ response : AnyObject) -> Void, failure: @escaping (_ error : AnyObject?) -> Void) {
        ...
        // Pass parameter or customer encoder is n
        let request = Alamofire.request(self.requestUrl!, method: self.requestMethod!, parameters: jsonObject, encoding: JSONEncoding.default, headers: headers)
    ...
    open func runEncodeUrl(_ parameters: [String:AnyObject], completion: @escaping (_ response : AnyObject) -> Void, failure: @escaping (_ error : AnyObject?) -> Void) {
    ...
    func handleResponse(_ response: DataResponse<Any>, completion: @escaping (_ response :AnyObject) -> Void, failure: @escaping (_ error:AnyObject?) -> Void){
    ...
    open func parseDict(_ dict : [String: Any]) -> AnyObject? {
        ...
        case RestClientEndpoints.WifiRadio:
            ...
            return dict["TransactionId"] as AnyObject
            
        case RestClientEndpoints.Transactions:
            // Returns Transaction State
            return dict["State"] as AnyObject
